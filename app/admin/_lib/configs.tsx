...
export const HOTEL_CONFIG: CrudConfig<HotelRow> = {
  ...
  fields: [
    ...
    { key: 'image', label: 'Foto principal', kind: 'image', required: true, span: 2, folder: 'hotels' },
...
export const PACKAGE_CONFIG: CrudConfig<PackageRow> = {
  ...
  fields: [
    ...
    { key: 'image', label: 'Foto principal', kind: 'image', required: true, span: 2, folder: 'packages' },
...
export const VILLA_CONFIG: CrudConfig<VillaRow> = {
  ...
  fields: [
    ...
    { key: 'country', label: 'País', kind: 'text', required: true },
    { key: 'image', label: 'Foto principal', kind: 'image', required: true, span: 2, folder: 'villas' },
...
export const CAR_CONFIG: CrudConfig<CarRow> = {
  ...
  fields: [
    ...
    { key: 'image', label: 'Foto del auto', kind: 'image', required: true, span: 2, folder: 'cars' },
...
export const ACTIVITY_CONFIG: CrudConfig<ActivityRow> = {
  ...
  fields: [
    ...
    { key: 'image', label: 'Foto de la experiencia', kind: 'image', required: true, span: 2, folder: 'activities' },
...
export const DESTINATION_CONFIG: CrudConfig<DestinationRow> = {
  ...
  fields: [
    ...
    { key: 'image', label: 'Foto del destino', kind: 'image', required: true, span: 2, folder: 'destinations' },
...
export const BLOG_CONFIG: CrudConfig<BlogRow> = {
  ...
  fields: [
    ...
    { key: 'image', label: 'Foto de portada', kind: 'image', required: true, span: 2, folder: 'blog' },
...
export const TESTIMONIAL_CONFIG: CrudConfig<TestimonialRow> = {
  ...
  fields: [
    ...
    { key: 'avatar', label: 'Foto del avatar', kind: 'image', required: true, span: 2, folder: 'testimonials' },
